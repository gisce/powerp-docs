...
Aquest mòdul implementa la generació de fitxers de mesures `Anexo VII` a l'ERP de Distribuïdora.

Aquests són **informes de corbes de carga horària (CCH)** agrupats perles diferents tàfires (TD) que la Distribuïdora enviarà a la "Comisión Nacional de los Mercados y la Competencia (CNMC)" amb una periodicitat anual. Els fitxers recullen les dades de tot l'any anterior.
...
El menú Anexo VII es troba dintre del menú principal `Administració pública > CNMC > Actualizació peatjes d'accés`. Aquí trobarem els apartats necessaris per a la
...
- **Any**: L'any pel qual volem realitzar el fitxer. Haurià de ser el que surt per defecte, que sera l'any anterior.
...
[ ![Assistent Anexo VII de descarga de fitxers](_static/medidas_anexo_VII/wizard_anexo_VII_download.png)](_static/medidas_anexo_VII/wizard_anexo_VII_download.png)
...
[ ![Llista de fitxers generats de forma asíncrona](_static/medidas_anexo_VII/list_async_files.png)](_static/medidas_anexo_VII/list_async_files.png)
...
[ ![Bóto per la descargar zip Anexo VII](_static/medidas_anexo_VII/wizard_download_all.png)](_static/medidas_anexo_VII/wizard_download_all.png)
