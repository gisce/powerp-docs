...
- [Descripció dels diferents Fitxers de l'inventari](#descripcio-dels-diferents-fitxers-de-linventari)
    ...
    - [Màquina](#node-maquina-inventario_r1-xxx_5txt)
    - [Despatx](#node-despatx-inventario_r1-xxx_6txt)
    - [Equips de millora de la fiabilitat](#node-equips-de-millora-de-la-fiabilitat-inventario_r1-xxx_7txt)
    - [Centres de transformació](#node-centres-de-transformacio-inventario_r1-xxx_8txt)
...
|               | CONDUCTOR ASSOCIAT AL TRAMB_BT I LA TENSIÓ DEL TRAM AL CAMP  |
| CAPACIDAD     | **VOLTATGE**.                                                |
|               |                                                              |
|               | `c = Tensió · Int.max. · √3`                                 |
+---------------+--------------------------------------------------------------+
