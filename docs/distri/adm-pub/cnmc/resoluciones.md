...
s'han de carregar els fitxers presentat de la 4666 del 2017. El fromat dels
...
4666/2017/Carregar Fitxer presentat 4666 n-1_"
...
es calculen els camps de la 4666 a partir de valors de camps de la BD i càlculs
addicionals.

| CAMP                       |CAMP DE LA BASE DE DADES                                                                  |
|----------------------------|------------------------------------------------------------------------------------------|
|CODIGO_CCAA_1               |EN FUNCIÓ DEL MUNICIPI DE LA LAT I LA CCAA RELACIONADA A LA TAULA 4 DE LA RESOLUCIÓ  4666 |
...
Feta la comparació dels elements amb el fitxer de la 4666 de l’any n-1, es defineixen els 3 estats diferents:
...
i es calculen els camps de la 4666 a partir de valors de camps de la BD i
càlculs addicionals.
...
Camps **CALCULATS**: En aquest cas el valor no existeix en un camp de la BD i
es calculen els camps de la 4666 a partir de valors de camps de la BD i
càlculs addicionals.
